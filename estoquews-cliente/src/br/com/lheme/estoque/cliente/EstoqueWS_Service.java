 ...
 * 
 */
@WebServiceClient(name = "EstoqueWS", targetNamespace = "http://ws.estoque.lheme.com.br/", wsdlLocation = "http://localhost:8080/estoquews-web/EstoqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ESTOQUEWS_QNAME = new QName("http://ws.estoque.lheme.com.br/", "EstoqueWS");
    ...
    public EstoqueWS getEstoqueWSImplPort() {
        return super.getPort(new QName("http://ws.estoque.lheme.com.br/", "EstoqueWSImplPort"), EstoqueWS.class);
    }
    ...
    public EstoqueWS getEstoqueWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.lheme.com.br/", "EstoqueWSImplPort"), EstoqueWS.class, features);
    }
